...
void loop(){
  ...
  analogWrite(ledIR, 0); // apaga o Led vermelho do IR
...
void termometro() { // Leitura do termometro
  ...
  temperaturas[101]  = ( temperaturas[0]   + temperaturas[1]  + temperaturas[2]
    ...
    + temperaturas[67] + temperaturas[68] + temperaturas[69] + temperaturas[70]
...
void sensorluz() { // Rotina do sensor de luz
  ...
  if (ldrvalor > 240 && segundo > segundo3) {
    pwm = 0;
    ledpwm = 30;
